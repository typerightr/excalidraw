 ...
 */
export declare const renderFrameBackground: (frame: ExcalidrawFrameLikeElement, context: CanvasRenderingContext2D, appState: StaticCanvasAppState | InteractiveCanvasAppState) => void;
